...
public class CustomerCampaign implements Serializable {
	...
	public String toString() {
		return "CustomerCampaign [id=" + id + ", createdon=" + createdon + ", email=" + email + ", modifiedon="
				+ modifiedon + ", nohp=" + nohp + ", reminderon=" + reminderon + ", customer=" + customer + ", product="
				+ product + ", reason=" + reason + ", status=" + status + ", user1=" + user1 + ", user2=" + user2 + "]";
	}
